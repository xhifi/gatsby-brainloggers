...
const PreNav = () => {
    return (
        <div className="py-0 bg-main-dark shadow-2 font-sm d-none d-lg-block">
            ...
            <ul className="nav">
                <a href="/" className="nav-link link-dark nav-link-social px-2 text-main"><li className="nav-item border-start ending-list"><BsFacebook className="mx-1" /></li></a>
                <a href="/" className="nav-link link-dark nav-link-social px-2 text-main"><li className="nav-item border-start ending-list"><BsInstagram className="mx-1" /></li></a>
                <a href="/" className="nav-link link-dark nav-link-social px-2 text-main"><li className="nav-item border-start ending-list"><BsGoogle className="mx-1" /></li></a>
                <a href="/" className="nav-link link-dark nav-link-social px-2 text-main"><li className="nav-item border-start ending-list"><BsGithub className="mx-1" /></li></a>
            </ul>
            </div>
        </div>
    )
